'''
utils required for freezing after adding the future module as a dep
not useful to end users so kept out of the way here
'''
...
def freeze_future_fix(dist_dir, freezer):
    ...
    '''
    # os.getcwd() will refer to the dist/ folder
